...
const Array1DTracer = () => {
    return (
        <Typography style={{ padding: '20px', backgroundColor: 'white', height: 'calc(100% - 46px)', overflow: "auto" }}>
            <Title>Array1DTracer</Title>
            <Title level={3}>构造函数</Title>
            <Card title="constructor" style={{ width: 450 }}>
                <Paragraph>new Array1DTracer(title?: <Text italic>undefined</Text> | <Text italic>string</Text>): <Text italic>Array1DTracer</Text></Paragraph>
